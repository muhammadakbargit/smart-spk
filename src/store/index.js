...
export const store = new Vuex.Store({
  state: {
    ...
    items: [
      ...
      { id: 2, icon: 'person_add', text: 'Register', link: '/register', auth: false },
      { id: 3, icon: 'exit_to_app', text: 'Login', link: '/login', auth: false },
      { id: 4, icon: 'info', text: 'Information', link: '/information', auth: false },
      { id: 5, icon: 'dashboard', text: 'Dashboard', link: '/dashboard', auth: true },
